...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="min-h-0 sm:min-h-[calc(100vh-5rem)] flex items-center justify-center py-6 sm:py-8 md:py-12 relative overflow-hidden scroll-mt-20">
